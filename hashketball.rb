...
def num_points_scored(player_choice)
  game_hash.each do |_place, team|
    team.each do |attribute, data|
      next unless attribute == :players

      data.each do |player|
        return player[:points] if player[:player_name] == player_choice
      end
    end
  end
end

def shoe_size(player_choice)
  game_hash.each do |_place, team|
    team.each do |attribute, data|
      next unless attribute == :players

      data.each do |player|
        return player[:shoe] if player[:player_name] == player_choice
      end
    end
  end
end
...
def team_colors(team_name)
  game_hash.each do |_place, team|
    return game_hash[_place][:colors] if team[:team_name] == team_name
  end
end
...
def player_stats(player_choice)
  new_hash = {}
